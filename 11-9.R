...
mydata = read.csv("D:\\Documents\\DataAnalysis\\dataset\\mba.csv")

Onlinedata = read.csv("D:\\Documents\\DataAnalysis\\dataset\\OnlineRetail.csv")
...
dtOnline <- split(Onlinedata$Description, Onlinedata$InvoiceNo)
