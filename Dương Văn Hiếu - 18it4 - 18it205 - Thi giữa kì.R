...
range(age)
chiatuoi <- cut(data$age, c(-Inf,32,40,60,Inf))
chiatuoi
table(chiatuoi)
...
barplot(age.ten, beside = TRUE, main="Tuoi bi")

pie(table(age.ten))

441 / (2472+ 441)

# => từ kết quả có thể suy ra nhóm có khả năng cao mắc bệnh tim là từ 40 -> 60
# => 15% khả năng mắc bệnh ở nhóm tuổi này cao nhất trong 4 nhóm 
...
# Độ tuổi trung bình mắc bệnh là 54,3 Khớp với nhóm tuổi có tỉ lệ mắc bệnh cao
